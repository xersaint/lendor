    ...
    <div className='py-20 container'>
      <div className="grid grid-cols-2">
        <div className="container flex flex-col gap-8">
          ...
          <p >Address: <span className='text-primary'>211 N. Bacalso Avenue 6000 Cebu City Cebu Philippines</span></p>
          <p>Phone: <span className='text-primary'>+44 168 4892 229</span></p>
          <p>Email: <span className='text-primary'>info@hostelpizzaordering.com</span></p>
