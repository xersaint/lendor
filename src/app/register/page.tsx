  ...
  return (
    <section className="pt-12 pb-20">
      ...
      <form className="flex flex-col gap-2 max-w-lg mx-auto mt-12" onSubmit={handleFormSubmit}>
        ...
        <input type="name" name="" id="name" value={name} onChange={(e :any) => setName(e.target.value)} className="bg-white p-2 mb-5 text-primary-200" />
        ...
        <input type="email" name="" id="email" value={email} onChange={(e :any) => setEmail(e.target.value)} disabled={creatingUser} className="bg-white p-2 mb-5 text-primary-200" />
        ...
        <input type="password" name="" id="password" value={password} onChange={(e :any) => setPassword(e.target.value)} disabled={creatingUser} className="bg-white p-2 mb-5 text-primary-200" />
